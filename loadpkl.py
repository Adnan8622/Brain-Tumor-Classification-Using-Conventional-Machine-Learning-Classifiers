...
def run_example():
	...
	model=joblib.load('SVM train model.pkl')
	# predict the class
...
### Pass the label to image
	if digit[0] == 'Normal':
		...
		cv2.putText(img,('Normal'),(50,50), font, 1,(0,0,255),2,cv2.LINE_AA)
		...
		font=cv2.FONT_HERSHEY_SIMPLEX
		cv2.putText(img,('Tumor'),(50,50), font,1,(0,0,255),2,cv2.LINE_AA)
		cv2.imshow('Image',img)
		#cv2.imshow(str(digit),imag)
		cv2.waitKey(0)
